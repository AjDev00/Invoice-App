  ...
  return (
    <div>
      <div className="font-eb-garamond flex flex-row justify-between px-4 pt-7 items-center">
        <div>
          <div className="font-bold text-[26px] tracking-[-1px] leading-8">
            Invoices
          </div>
          <div className="font-extrabold tracking-[-1px] opacity-50">
            No invoices
          </div>
        </div>
        <div className="flex flex-row gap-4">
          <div className="flex flex-row justify-center items-center gap-2">
            <div className="font-bold text-[18px]">Filter</div>
            <img src={arrowDown} alt="" className="w-2 h-2" />
          </div>
